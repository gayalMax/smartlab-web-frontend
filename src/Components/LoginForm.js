...
const LoginForm = () => {
  ...
  return (
    <form className={clsx(classes.root)} noValidate autoComplete="off">
        ...
        <CardContent>
          <Grid className={clsx(classes.textMargin, classes.textField)}>
            ...
            <p className={clsx(classes.paragraph)}>
              You have been offered the role of |role|. Please sign up to create
              an account and get started
            </p>
            <p className={clsx(classes.paragraph, classes.warning)}>
              {values.errorMessage}
            </p>
          </Grid>
          <Grid>
          ...
          <Grid>
            ...
            >
              ...
              <p className={classes.paragraph}>
                Use 8 or more characters with a mix of letters, symbols and
                numbers
              </p>
            </FormControl>
          </Grid>
